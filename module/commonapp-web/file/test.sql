...
INSERT INTO `role_resource` VALUES (1,1,1),(2,1,2),(3,1,3),(4,2,1),(5,2,2),(6,2,3);
...
INSERT INTO `sys_resource` VALUES (1,2,'添加用户1','admin:user:addUser','/admin/user/addUser',111,'添加用户',1),(2,3,'用户管理','admin:user:viewUsers','/admin/user/viewUsers',11,'查看用户',1),(3,0,'权限管理','admin:permission','权限管理',1,'权限管理',1);
...
INSERT INTO `sys_role` VALUES (1,'管理员','管理员',1,1),(2,'普通用户','普通用户',1,0);
...
INSERT INTO `user_info` VALUES (1,'admin','e6e061838856bf47e1de730719fb2609',1,1),(2,'users','e6e061838856bf47e1de730719fb2609',1,0),(7,'test','test',NULL,NULL),(9,'test','test',NULL,NULL);
...
-- Dump completed on 2015-08-14  9:57:00
